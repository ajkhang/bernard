...
You wake up fresh each session. These files are your continuity, organized into three layers:
...
├── people/
│   └── [name]/
│       ├── summary.md    # Living summary (loaded by default)
...
2. Only load `items.json` when you need specific facts or history
...
Raw event logs — what happened, when. Write continuously throughout the day.

### Layer 3: Tacit Knowledge (`MEMORY.md`)
Patterns, preferences, lessons learned about Andrew. How *he* operates, not facts about the world.
